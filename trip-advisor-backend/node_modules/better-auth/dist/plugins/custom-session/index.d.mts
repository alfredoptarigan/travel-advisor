...
import * as better_call224 from "better-call";
...
declare const customSession: <Returns extends Record<string, any>, O extends BetterAuthOptions = BetterAuthOptions>(fn: (session: {
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call224.MiddlewareInputContext<better_call224.MiddlewareOptions>) => Promise<Awaited<Returns>[] | undefined>;
    }[];
  };
  endpoints: {
    getSession: better_call224.StrictEndpoint<"/get-session", {
      method: "GET";
