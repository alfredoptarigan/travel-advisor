...
import * as better_call193 from "better-call";
...
declare const oneTimeToken: (options?: OneTimeTokenOptions | undefined) => {
  ...
  endpoints: {
     ...
     */
    generateOneTimeToken: better_call193.StrictEndpoint<"/one-time-token/generate", {
      method: "GET";
      use: ((inputContext: better_call193.MiddlewareInputContext<better_call193.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    verifyOneTimeToken: better_call193.StrictEndpoint<"/one-time-token/verify", {
      method: "POST";
      body: z.ZodObject<{
        token: z.ZodString;
      }, z.core.$strip>;
  ...
  hooks: {
    after: {
      matcher: () => true;
      handler: (inputContext: better_call193.MiddlewareInputContext<better_call193.MiddlewareOptions>) => Promise<void>;
    }[];
  };
