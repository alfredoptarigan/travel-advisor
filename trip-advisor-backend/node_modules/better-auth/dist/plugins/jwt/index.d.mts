...
declare const jwt: <O extends JwtOptions>(options?: O) => {
  ...
  options: NoInfer<O>;
  endpoints: {
    getJwks: better_call251.StrictEndpoint<string, {
      method: "GET";
      metadata: {
        openapi: {
          operationId: string;
    ...
    getToken: better_call251.StrictEndpoint<"/token", {
      method: "GET";
      requireHeaders: true;
      use: ((inputContext: better_call251.MiddlewareInputContext<better_call251.MiddlewareOptions>) => Promise<{
        session: {
    ...
    signJWT: better_call251.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
    ...
    verifyJWT: better_call251.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
