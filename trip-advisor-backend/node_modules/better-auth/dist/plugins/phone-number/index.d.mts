...
declare const phoneNumber: (options?: PhoneNumberOptions | undefined) => {
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call166.MiddlewareInputContext<better_call166.MiddlewareOptions>) => Promise<never>;
    }[];
  };
  endpoints: {
    signInPhoneNumber: better_call166.StrictEndpoint<"/sign-in/phone-number", {
      method: "POST";
      body: zod441.ZodObject<{
        phoneNumber: zod441.ZodString;
        password: zod441.ZodString;
        rememberMe: zod441.ZodOptional<zod441.ZodBoolean>;
      }, zod_v4_core61.$strip>;
      metadata: {
        openapi: {
          summary: string;
    ...
    sendPhoneNumberOTP: better_call166.StrictEndpoint<"/phone-number/send-otp", {
      method: "POST";
      body: zod441.ZodObject<{
        phoneNumber: zod441.ZodString;
      }, zod_v4_core61.$strip>;
    ...
    verifyPhoneNumber: better_call166.StrictEndpoint<"/phone-number/verify", {
      method: "POST";
      body: zod441.ZodObject<{
        phoneNumber: zod441.ZodString;
        code: zod441.ZodString;
        disableSession: zod441.ZodOptional<zod441.ZodBoolean>;
        updatePhoneNumber: zod441.ZodOptional<zod441.ZodBoolean>;
      }, zod_v4_core61.$strip>;
      metadata: {
        openapi: {
          summary: string;
    ...
    requestPasswordResetPhoneNumber: better_call166.StrictEndpoint<"/phone-number/request-password-reset", {
      method: "POST";
      body: zod441.ZodObject<{
        phoneNumber: zod441.ZodString;
      }, zod_v4_core61.$strip>;
    ...
    resetPasswordPhoneNumber: better_call166.StrictEndpoint<"/phone-number/reset-password", {
      method: "POST";
      body: zod441.ZodObject<{
        otp: zod441.ZodString;
        phoneNumber: zod441.ZodString;
        newPassword: zod441.ZodString;
      }, zod_v4_core61.$strip>;
      metadata: {
        openapi: {
          description: string;
