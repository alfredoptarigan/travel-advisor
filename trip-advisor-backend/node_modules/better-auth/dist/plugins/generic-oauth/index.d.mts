...
import * as zod_v4_core74 from "zod/v4/core";
...
declare const genericOAuth: (options: GenericOAuthOptions) => {
  ...
  endpoints: {
    signInWithOAuth2: better_call242.StrictEndpoint<"/sign-in/oauth2", {
      method: "POST";
      body: zod486.ZodObject<{
        providerId: zod486.ZodString;
        callbackURL: zod486.ZodOptional<zod486.ZodString>;
        errorCallbackURL: zod486.ZodOptional<zod486.ZodString>;
        newUserCallbackURL: zod486.ZodOptional<zod486.ZodString>;
        disableRedirect: zod486.ZodOptional<zod486.ZodBoolean>;
        scopes: zod486.ZodOptional<zod486.ZodArray<zod486.ZodString>>;
        requestSignUp: zod486.ZodOptional<zod486.ZodBoolean>;
        additionalData: zod486.ZodOptional<zod486.ZodRecord<zod486.ZodString, zod486.ZodAny>>;
      }, zod_v4_core74.$strip>;
      metadata: {
        openapi: {
          description: string;
    ...
    oAuth2Callback: better_call242.StrictEndpoint<"/oauth2/callback/:providerId", {
      method: "GET";
      query: zod486.ZodObject<{
        code: zod486.ZodOptional<zod486.ZodString>;
        error: zod486.ZodOptional<zod486.ZodString>;
        error_description: zod486.ZodOptional<zod486.ZodString>;
        state: zod486.ZodOptional<zod486.ZodString>;
      }, zod_v4_core74.$strip>;
      metadata: {
    ...
    oAuth2LinkAccount: better_call242.StrictEndpoint<"/oauth2/link", {
      method: "POST";
      body: zod486.ZodObject<{
        providerId: zod486.ZodString;
        callbackURL: zod486.ZodString;
        scopes: zod486.ZodOptional<zod486.ZodArray<zod486.ZodString>>;
        errorCallbackURL: zod486.ZodOptional<zod486.ZodString>;
      }, zod_v4_core74.$strip>;
