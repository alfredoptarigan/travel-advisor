...
import * as _better_auth_core_db26 from "@better-auth/core/db";
...
declare const apiKey: (options?: ApiKeyOptions | undefined) => {
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call732.MiddlewareInputContext<better_call732.MiddlewareOptions>) => Promise<{
        user: {
          id: string;
          createdAt: Date;
          updatedAt: Date;
        ...
        context: better_call732.MiddlewareContext<better_call732.MiddlewareOptions, {
          ...
          newSession: {
            session: _better_auth_core_db26.Session & Record<string, any>;
            user: _better_auth_core_db26.User & Record<string, any>;
          } | null;
          session: {
            session: _better_auth_core_db26.Session & Record<string, any>;
            user: _better_auth_core_db26.User & Record<string, any>;
          ...
          adapter: _better_auth_core_db_adapter1.DBAdapter<_better_auth_core29.BetterAuthOptions>;
          internalAdapter: _better_auth_core29.InternalAdapter<_better_auth_core29.BetterAuthOptions>;
          createAuthCookie: (cookieName: string, overrideAttributes?: Partial<better_call732.CookieOptions> | undefined) => _better_auth_core29.BetterAuthCookie;
          secret: string;
          sessionConfig: {
            updateAge: number;
            expiresIn: number;
          ...
          generateId: (options: {
            model: _better_auth_core_db26.ModelNames;
            size?: number | undefined;
          }) => string | false;
          secondaryStorage: _better_auth_core_db26.SecondaryStorage | undefined;
          password: {
          ...
          tables: _better_auth_core_db26.BetterAuthDBSchema;
  ...
  endpoints: {
     ...
     */
    createApiKey: better_call732.StrictEndpoint<"/api-key/create", {
      method: "POST";
      body: zod1944.ZodObject<{
        name: zod1944.ZodOptional<zod1944.ZodString>;
        expiresIn: zod1944.ZodDefault<zod1944.ZodNullable<zod1944.ZodOptional<zod1944.ZodNumber>>>;
        userId: zod1944.ZodOptional<zod1944.ZodCoercedString<unknown>>;
        prefix: zod1944.ZodOptional<zod1944.ZodString>;
        remaining: zod1944.ZodDefault<zod1944.ZodNullable<zod1944.ZodOptional<zod1944.ZodNumber>>>;
     ...
     */
    deleteAllExpiredApiKeys: better_call732.StrictEndpoint<string, {
      method: "POST";
    }, {
      success: boolean;
      error: unknown;
