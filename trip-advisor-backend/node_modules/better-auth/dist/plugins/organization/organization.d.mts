...
declare const createHasPermission: <O extends OrganizationOptions>(options: O) => better_call715.StrictEndpoint<"/organization/has-permission", {
  method: "POST";
  requireHeaders: true;
  ...
  use: ((inputContext: better_call715.MiddlewareInputContext<{
    ...
    session: {
      session: _better_auth_core_db24.Session & {
        activeTeamId?: string | undefined;
        activeOrganizationId?: string | undefined;
      };
      user: _better_auth_core_db24.User;
    };
  }>)[];
  metadata: {
    $Infer: {
