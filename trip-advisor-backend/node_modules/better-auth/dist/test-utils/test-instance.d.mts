...
declare function getTestInstance<O extends Partial<BetterAuthOptions>, C extends BetterAuthClientOptions>(options?: O | undefined, config?: {
  ...
  client: UnionToIntersection<(C extends undefined ? {} : C) & {
    ...
    readonly linkSocialAccount: better_call307.StrictEndpoint<"/link-social", {
      method: "POST";
      requireHeaders: true;
      body: zod618.ZodObject<{
        callbackURL: zod618.ZodOptional<zod618.ZodString>;
    ...
    readonly listUserAccounts: better_call307.StrictEndpoint<"/list-accounts", {
      method: "GET";
      use: ((inputContext: better_call307.MiddlewareInputContext<better_call307.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly deleteUserCallback: better_call307.StrictEndpoint<"/delete-user/callback", {
      method: "GET";
      query: zod618.ZodObject<{
        token: zod618.ZodString;
        callbackURL: zod618.ZodOptional<zod618.ZodString>;
    ...
    readonly unlinkAccount: better_call307.StrictEndpoint<"/unlink-account", {
      method: "POST";
      body: zod618.ZodObject<{
        providerId: zod618.ZodString;
        accountId: zod618.ZodOptional<zod618.ZodString>;
      }, zod_v4_core93.$strip>;
      use: ((inputContext: better_call307.MiddlewareInputContext<better_call307.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly refreshToken: better_call307.StrictEndpoint<"/refresh-token", {
      method: "POST";
      body: zod618.ZodObject<{
        providerId: zod618.ZodString;
        accountId: zod618.ZodOptional<zod618.ZodString>;
        userId: zod618.ZodOptional<zod618.ZodString>;
      }, zod_v4_core93.$strip>;
      metadata: {
        openapi: {
          description: string;
    ...
    readonly getAccessToken: better_call307.StrictEndpoint<"/get-access-token", {
      method: "POST";
      body: zod618.ZodObject<{
        providerId: zod618.ZodString;
        accountId: zod618.ZodOptional<zod618.ZodString>;
    ...
    readonly accountInfo: better_call307.StrictEndpoint<"/account-info", {
      method: "GET";
      use: ((inputContext: better_call307.MiddlewareInputContext<better_call307.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
  ...
  })["plugins"] extends (infer Plugin_1)[] ? UnionToIntersection<Plugin_1 extends _better_auth_core26.BetterAuthClientPlugin ? Plugin_1["getActions"] extends ((...args: any) => infer Actions) ? Actions : {} : {}> : {}) & UnionToIntersection<InferRoute<((C extends undefined ? {} : C) & {
    baseURL: string | undefined;
    fetchOptions: {
      customFetchImpl: (url: string | URL | Request, init?: RequestInit | undefined) => Promise<Response>;
    };
    ...
    $fetch: _better_fetch_fetch96.BetterFetch<{
      plugins: (_better_fetch_fetch96.BetterFetchPlugin<Record<string, any>> | {
        ...
        hooks: {
          ...
          onRequest: (<T_1 extends Record<string, any>>(context: _better_fetch_fetch96.RequestContext<T_1>) => Promise<_better_fetch_fetch96.RequestContext | void> | _better_fetch_fetch96.RequestContext | void) | undefined;
    ...
    $store: {
      ...
      atoms: Record<string, nanostores4.WritableAtom<any>>;
    };
    $Infer: {
